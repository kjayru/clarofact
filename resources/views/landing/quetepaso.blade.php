        ...
        <section class="pagina pagina--quetepasoestemes">
            ...
            <article>
                    <ul class="quetepasoestemes__lista">
                        <li class="quetepasoestemes__item act">
                            <a href="#tengo_una_nueva_linea">
                                <img src="img/tengo_una_nueva_linea.svg" alt="">
                                <strong>Tengo una <br>nueva línea</strong>
                            </a>
                        </li>
                        <li class="quetepasoestemes__item">
                            <a href="#no_pague_a_tiempo">
                                <img src="img/no_pague_a_tiempo.svg" alt="">
                                <strong>No pagué <br>a tiempo</strong>
                            </a>
                        </li>
                        <li class="quetepasoestemes__item">
                            <a href="#me_cobraron_mas">
                                <img src="img/me_cobraron_mas.svg" alt="">
                        ...
                        <li class="quetepasoestemes__item">
                            <a href="#pague_menos">
                                <img src="img/pague_menos.svg" alt="">
                                <strong>Pagué <br>menos</strong>
                            </a>
                        </li>
                        <li class="quetepasoestemes__item">
                            <a href="#me_robaron_mi_celular">
                                <img src="img/me_robaron_mi_celular.svg" alt="">
                                <strong>Me robaron <br>mi celular</strong>
                            </a>
                        </li>
                        <li class="quetepasoestemes__item">
                            <a href="#sali_de_viaje">
                                <img src="img/sali_de_viaje.svg" alt="">
                                <strong>Salí de <br>viaje</strong>
                            </a>
                        </li>
                    </ul>
            </article>
           <!-- <span class="quetepasoestemes__txtMobile">Elige una opción para ver el detalle del recibo</span>-->
            <div class="limit " id="quepaso">
                <div class="listadoStandardContenedor listadoStandardContenedor--quetepasoestemes">
                	
                    <ul id="tengo_una_nueva_linea" class="listadoStandard act">
                    	<li class="list-head"><p>Puede que tu primer recibo, adicional al pago del mes, se sume uno de estos escenarios:</p></li>
                        <li>
                            <article>
                                <h3>Equipo con cuotas</h3>
                                <p>
                    ...
                    <ul id="no_pague_a_tiempo" class="listadoStandard">
                    	<li class="list-head"><p>Puede que haya ocurrido lo siguiente:</p></li>
                        <li>
                            <article>
                                <h3>Olvidé cuando vence mi recibo</h3>
                        ...
                        <li>
                            <article>
                                <h3>Cambió la fecha de vencimiento de mi recibo</h3>
                        ...
                        <li>
                            <article>
                                <h3>Mi ciclo de facturación cambió</h3>
                        ...
                        <li>
                            <article>
                                <h3>No recordaba dónde pagar</h3>
                        ...
                        <li>
                            <article>
                                <h3>No me llegó el recibo</h3>
                                <p>Puede que te hayas mudado o no recuerdes el correo al que te afiliaste para recibirlo. Te sugerimos verificar tu dirección de envío llamando al 123 desde tu móvil. Recuerda que también puedes visualizar tus 6 últimos recibos a través de <a href="https://mi.claro.com.pe" target="_blank">Mi Claro</a>.   
                                </p>
                                <p>Se parte del cambio, cuida el medio ambiente y afíliate GRATIS al envío de recibo por email <a href=" http://catalogo.claro.com.pe/forma/365/recibo-correo" target="_blank">aquí</a>.
                                </p>
                            </article>
                        </li>
                    </ul>
                    <ul id="me_cobraron_mas" class="listadoStandard">
                        <li class="list-head"><p>En realidad pueden sumarse cargos por:</p></li>
                        <li>
                            <article>
                                <h3>Compra de paquete de datos</h3>
                        ...
                        <li>
                            <article>
                                ...
                                <p>Si solicitaste una facturación con todas las llamadas realizadas y recibidas de los últimos 3 meses, se te cobrará un cargo de S/ 7 adicional a tu siguiente recibo.</p>
                            </article>
                        </li>  
                         <li>
                            <article>
                                <h3>Consumo abierto</h3>
                                <p>El servicio de consumo abierto te permite generar consumos adicionales de minutos, megas y SMS por no tener un límite establecido.</p>
                            </article>
                        </li>    
                         <li>
                            <article>
                                <h3>Roaming</h3>
                                <p>Si viajaste fuera del país e hiciste uso de tu servicio móvil, puede que se generen costos adicionales en tu siguiente recibo (ver  Cobertura Sin Frontera). Recuerda que para utilizar el servicio de Roaming tu plan debe tener Consumo abierto o Consumo adicional. <a href="http://roaming.claro.com.pe/" target="_blank">Ir a roaming ></a></p>
                            </article>
                        </li>                                                                                          
                    </ul>
                    <ul id="pague_menos" class="listadoStandard">
                        <li class="list-head"><p>Puede haber ocurrido lo siguiente:</p></li>
                        <li>
                            <article>
                                <h3>Bloqueaste tu línea por robo</h3>
                                <p>Si realizaste el bloqueo de tu línea y recuperaste tu chip días después, es probable que el monto a pagar de tu recibo sea menor. Recuerda que no te cobramos por los días que no tienes servicio.</p>
                            </article>
                        </li>
                        <li>
                            <article>
                                <h3>Suspendiste tu línea</h3>
                                <p>En el periodo de suspensión temporal solicitado (máximo 90 días), no se realizarán cobros por el servicio. Sin embargo, la transacción tiene un costo de S/ 30, monto que se visualizará en el recibo posterior a la reactivación.</p>
                            </article>
                        </li>
                        <li>
                            <article>
                                <h3>Renta adelantada</h3>
                        ...
                        <!--<li>
                            <article>
                                <h3>Ajuste de cargo fijo por retención</h3>
                    ...
                    <ul id="me_robaron_mi_celular" class="listadoStandard">
                        <li class="list-head"><p>Pueden ocurrir ajustes en tu facturación porque:</p></li>
                        <li>
                            <article>
                                <h3>Bloqueé mi línea por robo o perdida</h3>
                    ...
                    <ul id="sali_de_viaje" class="listadoStandard">
                        <li class="list-head"><p>Pueden generarse cobros adicionales por:</p></li>
                    
                        <li>
                            <article>
                                <h3>Sobrepasar los minutos, megas y SMS de mi Cobertura Sin Frontera</h3>
                                <p>Si viajaste a uno de los 17 países con Cobertura Sin Frontera y sobre pasaste los minutos, megas o SMS correspondientes a tu plan Claro MAX, recuerda que se aplicarán tarifas adicionales si tu plan cuenta con límite de Consumo libre o Consumo adicional. <a href="http://roaming.claro.com.pe/" target="_blank">Ir a Cobertura Sin Frontera ></a></p>
                            </article>
                        </li>
                        <li>
                            <article>
                                <h3>No activé un paquete roaming</h3>
                        ...
                        <li>
                            <article>
                                <h3>No conocía las tarifas roaming</h3>
